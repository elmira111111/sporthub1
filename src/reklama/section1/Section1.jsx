...
import './Section1.css'; // подключаем стили
import { SlidersHorizontal } from 'lucide-react'; // иконка

const Section1 = () => {
    const [isModalOpen, setIsModalOpen] = useState(false);
    const [activeLabel, setActiveLabel] = useState(''); // Состояние для активного элемента

    const handleLabelClick = (label) => {
        setActiveLabel(label); // Устанавливаем активный элемент
    };
